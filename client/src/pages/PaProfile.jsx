                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(12, 1fr)', gap: '40px' }}>
                        ...
                        <div style={{ gridColumn: 'span 8', display: 'flex', flexDirection: 'column', gap: '32px' }}>
                            ...
                            <section style={{ backgroundColor: '#FFFFFF', borderRadius: '32px', boxShadow: '0 10px 20px rgba(99, 102, 241, 0.03)', border: '1px solid rgba(224, 231, 255, 0.5)', overflow: 'hidden' }}>
                                <div style={{ padding: '3px 4px', borderBottom: '1px solid #F8FAFC', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                ...
                                <div style={{ padding: '6px', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '40px' }}>
                                    ...
                                    <div style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
                                        <div style={{ height: '36px', width: '36px', borderRadius: '16px', backgroundColor: '#F8FAFC', display: 'flex', alignItems: 'center', justifyContent: 'center', border: '1px solid #E2E8F0' }}>
                            ...
                            {/* Contact Information */}
                            <section style={{ backgroundColor: '#FFFFFF', borderRadius: '32px', boxShadow: '0 10px 20px rgba(99, 102, 241, 0.03)', border: '1px solid rgba(224, 231, 255, 0.5)', overflow: 'hidden' }}>
                                <div style={{ padding: '6px 6px', borderBottom: '1px solid #F8FAFC', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                    <h3 style={{ fontSize: '20px', fontWeight: 900, display: 'flex', alignItems: 'center', gap: '16px', color: '#1E1B4B', margin: 0 }}>
                                        <div style={{ padding: '10px', backgroundColor: '#EEF2FF', borderRadius: '12px', color: '#6366F1' }}>
